...
class SearchRequestStatus(Base):
    __tablename__ = "SearchRequestStatus"
    SearchRequestStatusId = Column(Integer, primary_key=True, index=True)
    ...
    SearchRequest = relationship(
        "SearchRequest", back_populates="SearchRequestStatus"
    )
