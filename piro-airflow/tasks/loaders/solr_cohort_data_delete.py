...
class SolrCohortDataDelete:
    ...
    def _delete_data(self) -> bool:
        ...
        records_to_delete: list[LegacyRow] = self._get_records_to_delete()
    ...
    def _get_records_to_delete(self) -> list[LegacyRow]:
    ...
    def _get_trigger_to_process(self) -> bool:
        """Query the V_SOLR_Cohort_Delete_Load view for records to be deleted in SOLR."""   # noqa: E501
        select_query = text("""SELECT count(0) From [V_AIRFLOW_Cohort_Delete_Load]""")  # noqa: E501
