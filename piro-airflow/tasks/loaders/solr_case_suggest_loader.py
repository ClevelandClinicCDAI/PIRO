...
from tasks.utils.solr_setup import (
    get_solr_case_suggest_data_import_url,
    get_solr_case_suggest_data_update_url,
    get_solr_case_suggest_data_update_batch,
)
from tasks.utils.solr_setup import get_solr_case_suggest_status_url
from tasks.utils.solr_setup import get_solr_header_auth
from tasks.utils.solr_setup import get_solr_case_suggest_data_count_url
import time

logger = get_logger()


class SolrCaseSuggestLoader:
    ...
    def __init__(self):
        logger.info("SolrCaseSuggestLoader constructor-Start")
        ...
        self.solr_loader_url = get_solr_case_suggest_data_import_url()
        self.solr_update_url = get_solr_case_suggest_data_update_url()
        self.solr_status_url = get_solr_case_suggest_status_url()
        self.solr_data_count_url = get_solr_case_suggest_data_count_url()
        self.solr_update_batch = get_solr_case_suggest_data_update_batch()
    ...
    def _upload_data_solr(self) -> bool:
        ...
        while process_data:
            ...
            data = self._get_case_suggest_data(key, data_record_count)
            if data is None:
                return True
