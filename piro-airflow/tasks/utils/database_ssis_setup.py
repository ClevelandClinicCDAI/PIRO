...
def get_piro_db_connection_params() -> tuple[str, str, str, str, str]:
    ...
    server = get_var("SSIS_PIRO_DB_SERVER")
    instance = get_var("SSIS_PIRO_DB_INSTANCE")
    db_name = get_var("SSIS_PIRO_DB_NAME")
    username = get_var("SSIS_PIRO_DB_USERNAME")
    password = get_var("SSIS_PIRO_DB_PASSWORD")
